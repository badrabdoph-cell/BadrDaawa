...
export function OrderForm({
  ...
  function getUrlDraft(): OrderDraft {
    ...
    return {
      ...
      story: params.has("story") ? cleanOrderStory(parseDraftJson(params.get("story"), [])) : undefined,
  ...
  useEffect(() => {
    try {
      ...
      setForm((current) => ({
        ...
        story: ensureMinimumOrderStoryItems(draft.story),
  ...
  function getCurrentFormFromDom(): OrderFormValues {
    ...
    return {
      ...
      notes: "",
      photographerName: String(formData.get("photographerName") || form.photographerName || "").trim(),
      photographerFacebookUrl: String(formData.get("photographerFacebookUrl") || form.photographerFacebookUrl || "").trim(),
      photographerInstagramUrl: String(formData.get("photographerInstagramUrl") || form.photographerInstagramUrl || "").trim(),
