...
export const neonThemeTemplate: TemplateDefinition = {
  id: "tpl_neon_theme",
  slug: "neon-theme",
  name: "Neon Theme",
  arabicName: "نيون مودرن",
  category: "قالب نيون عصري",
  style: "neon",
  concept: "دعوة داكنة بإضاءة نيون فوشيا وسماوي، أسماء متدرجة، صورة بإطار مضيء، وخريطة وQR بطابع سايبر.",
  opening: "Cyber neon glow",
  layout: "كارت أسماء نيون، صورة بإطار متدرج، عداد، خريطة، RSVP وQR.",
  typography: "أسماء عريضة بتدرج نيون مع تفاصيل رقمية واضحة على خلفية داكنة.",
  palette: {
    primary: "#09090b",
    secondary: "#18181b",
    accent: "#d946ef",
  ...
  previewImage: "/assets/templates/neon-theme.svg",
  accentImage: "/assets/invite/badr-sarah-2.jpeg",
  musicUrl: defaultTemplateMusicUrl,
  enabled: true,
  score: 92,
...
export const vintageThemeTemplate: TemplateDefinition = {
  ...
  slug: "vintage-theme",
  name: "Vintage Theme",
  arabicName: "فينتاج كلاسيك",
  category: "قالب فينتاج ورقي",
  style: "vintage",
...
export const fairytaleThemeTemplate: TemplateDefinition = {
  id: "tpl_fairytale_theme",
  slug: "fairytale-theme",
  name: "Fairytale Theme",
  arabicName: "حكاية وردية",
  category: "قالب رومانسي حالم",
  style: "ivory",
  concept: "دعوة وردية ناعمة بخلفية متدرجة، بطاقة أسماء شفافة، صورة دائرية، وخريطة وQR بطابع حكاية رومانسية.",
  opening: "Soft fairytale romance",
  layout: "بطاقة أسماء وردية، صورة دائرية، موعد، عداد، خريطة، RSVP وQR.",
  typography: "أسماء Serif رومانسية مع ألوان وردية ناعمة ومساحات مريحة للهاتف.",
  palette: {
    primary: "#fff0f5",
    secondary: "#ffe4e1",
    accent: "#f4a9c4",
  ...
  previewImage: "/assets/templates/fairytale-theme.svg",
  accentImage: "/assets/invite/badr-sarah-1.jpeg",
  musicUrl: defaultTemplateMusicUrl,
  enabled: true,
  score: 92,
...
export const oceanThemeTemplate: TemplateDefinition = {
  id: "tpl_ocean_theme",
  slug: "ocean-theme",
  name: "Ocean Theme",
  arabicName: "أوشن أزرق",
  category: "قالب أزرق منعش",
  style: "ocean",
  concept: "دعوة زرقاء منعشة بواجهة متدرجة، صورة نظيفة، كروت موعد بيضاء، وخريطة وQR بطابع هادئ.",
  opening: "Blue ocean celebration",
  layout: "غلاف أزرق، صورة، كروت تاريخ ووقت، عداد، خريطة، RSVP وQR.",
  typography: "أسماء عريضة وواضحة مع أزرق منعش ومساحات مرتبة مناسبة للهاتف.",
  palette: {
    primary: "#f0f8ff",
    secondary: "#3b82f6",
    accent: "#1d4ed8",
  ...
  previewImage: "/assets/templates/ocean-theme.svg",
  accentImage: "/assets/invite/badr-sarah-1.jpeg",
  musicUrl: defaultTemplateMusicUrl,
  enabled: true,
  score: 92,
