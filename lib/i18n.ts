...
export const dictionaries = {
  ar: {
    ...
    invitation: {
      ...
      shareCard: "مشاركة الدعوة",
      qrAlt: "QR Code للدعوة",
      qrText: "امسح الرمز لمشاركة الدعوة",
      countdownLabel: "العد التنازلي ليوم الحفل",
      ...
      map: {
        ...
        ready: "موقع الخريطة",
        visitorLocation: "موقعك الحالي تقريباً",
        useMyLocation: "موقعي",
        locationSoon: "سيتم إضافة موقع الحفل قريباً ✨",
        locating: "بنحدد موقعك الآن",
        actionsLabel: "خيارات فتح خريطة مكان الحفل",
        openGoogle: "عرض الموقع على الخريطة",
      ...
      coupleMessages: {
        ...
        messagePlaceholder: "اكتب تهنئتك أو رسالتك هنا",
        submit: "إرسال التهنئة",
        previewNote: "هذا نموذج يظهر شكل رسائل العروسين داخل القالب.",
        empty: "لا توجد رسائل بعد، كن أول من يترك كلمة جميلة ❤️",
      },
    },
    admin: {
      localeName: "العربية",
  ...
  en: {
    ...
    invitation: {
      ...
      map: {
        ...
        ready: "Map location",
        visitorLocation: "Approximate current location",
        useMyLocation: "My location",
        locationSoon: "The venue location will be added soon ✨",
